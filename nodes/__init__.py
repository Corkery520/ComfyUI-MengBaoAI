...
from .tools import (
    NODE_CLASS_MAPPINGS as TOOLS_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as TOOLS_DISPLAY_NAME_MAPPINGS,
)
...
_register_nodes(TOOLS_CLASS_MAPPINGS, TOOLS_DISPLAY_NAME_MAPPINGS)
